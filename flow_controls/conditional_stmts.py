...
# # #Hello this git test
# #
# # ## find the highest value in a liat
# list1=[10,20,30]
#
# print('the highest value in the list is:',max(list1))
#
# # ## find the lowest value in a liat
# list1=[10,20,30]
#
# print('the highest value in the list is:',min(list1))
#
# #second way to do the above question
#
number=int(input('enter the values here: '))

if number == 30:
    print('the highest value is:',number)
elif number == 10:
    print('the lowest value is:',number)
else:
    print('both highest and lowest not found')
